          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-green-900/30 to-blue-900/30 backdrop-blur-sm border border-green-500/30 rounded-3xl p-8">
                <h3 className="text-2xl font-bold mb-6">Performance Marketing System</h3>
                <div className="space-y-6">
                  <div className="flex items-center justify-between">
                    <span className="text-gray-300">Click-to-Sale Rate</span>
                    <span className="text-3xl font-bold text-green-400">23%</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-300">Ad Spend Efficiency</span>
                    <span className="text-3xl font-bold text-blue-400">+340%</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-300">Profit Per Click</span>
                    <span className="text-3xl font-bold text-green-400">$12.80</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Real campaigns that turned ad spend into profit machines
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-green-900/30 to-blue-900/30 border border-green-500/30 rounded-3xl p-8 text-center">
              <div className="text-4xl font-black mb-2 text-green-400">The Money Printer</div>
              <div className="text-gray-300 mb-4">$1 → $15 Return</div>
              <p className="text-sm text-gray-400">"Every dollar spent returns $15 in revenue"</p>
            </div>
            <div className="bg-gradient-to-br from-blue-900/30 to-purple-900/30 border border-blue-500/30 rounded-3xl p-8 text-center">
              ...
              <div className="text-gray-300 mb-4">10x Budget Growth</div>
              <p className="text-sm text-gray-400">"Scaled from $1K to $10K daily ad spend profitably"</p>
            </div>
            <div className="bg-gradient-to-br from-purple-900/30 to-pink-900/30 border border-purple-500/30 rounded-3xl p-8 text-center">
              <div className="text-4xl font-black mb-2 text-purple-400">The Efficiency Engine</div>
              <div className="text-gray-300 mb-4">89% Cost Reduction</div>
              <p className="text-sm text-gray-400">"Cut customer acquisition cost by 89%"</p>
            </div>
          </div>
        </div>
      </section>
