          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-cyan-900/30 to-purple-900/30 backdrop-blur-sm border border-cyan-500/30 rounded-3xl p-8">
                <h3 className="text-2xl font-bold mb-6">Social Commerce Engine</h3>
                <div className="space-y-6">
                  <div className="flex items-center justify-between">
                    <span className="text-gray-300">Content Viral Rate</span>
                    <span className="text-3xl font-bold text-cyan-400">34%</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-300">Follower-to-Customer Rate</span>
                    <span className="text-3xl font-bold text-purple-400">12%</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-300">Social Revenue Per Post</span>
                    <span className="text-3xl font-bold text-cyan-400">$890</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Real transformations from social media zero to hero
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-cyan-900/30 to-purple-900/30 border border-cyan-500/30 rounded-3xl p-8 text-center">
              <div className="text-4xl font-black mb-2 text-cyan-400">The Viral Sensation</div>
              <div className="text-gray-300 mb-4">50M Views in 30 Days</div>
              <p className="text-sm text-gray-400">"One campaign reached 50 million people organically"</p>
            </div>
            <div className="bg-gradient-to-br from-purple-900/30 to-pink-900/30 border border-purple-500/30 rounded-3xl p-8 text-center">
              <div className="text-4xl font-black mb-2 text-purple-400">The Community Builder</div>
              <div className="text-gray-300 mb-4">100K Engaged Followers</div>
              <p className="text-sm text-gray-400">"Built a community of 100K super-engaged fans"</p>
            </div>
            <div className="bg-gradient-to-br from-pink-900/30 to-red-900/30 border border-pink-500/30 rounded-3xl p-8 text-center">
              <div className="text-4xl font-black mb-2 text-pink-400">The Revenue Generator</div>
              <div className="text-gray-300 mb-4">$2M Social Commerce</div>
              <p className="text-sm text-gray-400">"Generated $2M in direct social media sales"</p>
            </div>
          </div>
        </div>
      </section>
