          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-pink-900/30 to-purple-900/30 backdrop-blur-sm border border-pink-500/30 rounded-3xl p-8">
                <h3 className="text-2xl font-bold mb-6">Brand Identity Blueprint</h3>
                <div className="space-y-6">
                  <div className="flex items-center justify-between">
                    <span className="text-gray-300">Brand Recall Rate</span>
                    <span className="text-3xl font-bold text-pink-400">96%</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-300">Emotional Connection Score</span>
                    <span className="text-3xl font-bold text-purple-400">8.9/10</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-300">Brand Preference Lift</span>
                    <span className="text-3xl font-bold text-pink-400">340%</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Real brands that went from invisible to irresistible
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-pink-900/30 to-purple-900/30 border border-pink-500/30 rounded-3xl p-8 text-center">
              <div className="text-4xl font-black mb-2 text-pink-400">The Love Brand</div>
              <div className="text-gray-300 mb-4">96% Brand Recall</div>
              <p className="text-sm text-gray-400">"Customers now choose us over bigger competitors"</p>
            </div>
            <div className="bg-gradient-to-br from-purple-900/30 to-indigo-900/30 border border-purple-500/30 rounded-3xl p-8 text-center">
              <div className="text-4xl font-black mb-2 text-purple-400">The Viral Identity</div>
              <div className="text-gray-300 mb-4">2M Social Impressions</div>
              <p className="text-sm text-gray-400">"Our rebrand went viral and tripled our following"</p>
            </div>
            <div className="bg-gradient-to-br from-indigo-900/30 to-blue-900/30 border border-indigo-500/30 rounded-3xl p-8 text-center">
              <div className="text-4xl font-black mb-2 text-indigo-400">The Premium Play</div>
              <div className="text-gray-300 mb-4">340% Price Increase</div>
              <p className="text-sm text-gray-400">"Now positioned as the luxury option in our market"</p>
            </div>
          </div>
        </div>
      </section>
